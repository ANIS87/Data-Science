...
SS=0
rows = []
rows.append(['_id','event','track_id','id_session','browser','browser_version','city','country','ip','resolution','hostname','time_arrival','pages_seen','referrer','time_spent','media','created_at','updated_at','latitude','longitude','cpc','src']  )
...
#rows.append([doc['_id'],doc['event'], A['track_id'],A['id_session'],A['browser'], A['browser_version'],A['city'],A['country'],A['ip'],A['resolution'],A['hostname'],A['time_arrival'],A['pages_seen'],A     ['referrer'],A['time_spent'],A['zipcode'],A['region'],A['latitude'],A['longitude'], B['id'], B['name'], B['url'],B['is_spinoff'], B['cpc'],C['apikey'],C['media'], C['options']['formatOption'],C['options']['guiOption'],C['brandName'] , C['contents'],doc['created_at'],doc['updated_at'], doc['created_at_date']] ):
      SS=SS+1
      rows.append([doc['_id'],doc['event'],A['track_id'],A['id_session'],A['browser'], A['browser_version'],A['city'],A ['country'],A['ip'],A['resolution'],A['hostname'],A['time_arrival'],A['pages_seen'],A['referrer'],A['time_spent'], C['media'],doc['created_at'],doc['updated_at'],A['latitude'],A['longitude'],B['cpc'], C['src'] ] )
   
with open('data_brut_clustering.csv', 'wb') as fp:
